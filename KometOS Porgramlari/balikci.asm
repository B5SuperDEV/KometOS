...
intro:  db 16,'Balik Yakalamaca',0
        db 1,0
        db 39,'Balik yakala ve puanlar kazan',0
        db 49,'Derinde baliklar daha degerli',0
        db 43,'Baliklar ipe degerce kanca düser',0
        db 45,'Kancalari bitirmemeye calis! Eger biterse...!!!',0
        db 1,0
        db 45,'Yukari asaigi dugmelerini kullan',0
        db 35,'ESC=Cik',0
        db 1,0
        db 20,'Enter=Basla',0
es      db 0
