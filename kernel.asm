...
option_screen:
	...
	os_init_msg		db 'KometOS (Windows Film Yapan 1.03 tarafindan gelistirildi!)', 0
	os_version_msg		db 'Version ', KOMETOS_VER, 0

	dialog_string_1		db 'KometOS a hosgeldiniz :D !', 0
	dialog_string_2		db 'Lutfen arayuz secin:', 0
	dialog_string_3		db 'GUI Grafik Arayuz CMD ise Komut istemi icin!', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Kernel yüklenemiyor :(', 0
	kerndlg_string_2	db 'KERNEL.BIN KometOS un cekirdegidir', 0
    kerndlg_string_3    db 've sonradan yurutulemez', 0
	ext_string_1		db 'Yanlis dosya tip', 0
	ext_string_2		db 'Sadece .BIN,.BAS dosyalari yurutulebilir', 0

	program_finished_msg	db '>>> Program kapatildi herhangi bir dügmeye bas...', 0
