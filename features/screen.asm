...
.esc_pressed:				; Set carry flag if Escape was pressed
	...
	.help_msg1	db 'Fare ile dosya sec!', 0
	.help_msg2	db 'Listeden tus sec...', 0
...
.noright:
	...
	.ok_button_string	db 'GUI', 0
	.cancel_button_string	db 'CMD', 0
	.ok_button_noselect	db '   GUI   ', 0
	.cancel_button_noselect	db '   CMD   ', 0
